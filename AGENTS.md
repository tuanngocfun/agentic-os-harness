...
- KHÔNG claim true `fork`, blocking `wait`, full exec address-space replacement, networking, graphics, persistent storage, or extra shell breadth without targeted runtime tests and updated `harness_profile.yaml` claim status
