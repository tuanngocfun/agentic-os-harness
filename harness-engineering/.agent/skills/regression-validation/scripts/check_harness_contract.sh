...
require_grep 'project_phase:[[:space:]]*"boot_to_shell_proven_stage2_preemptive_memory_ramdisk_vfs_simplefs_file_syscalls_elf_loader_process_lifecycle_per_process_fds_marker_trust_exec_args_red_blue_qemu_evidence"' "harness_profile.yaml"
...
runtime_scripts="address_space_test.sh allocator_test.sh boot_test.sh e820_test.sh elf_loader_test.sh exception_test.sh exec_args_test.sh marker_surface_test.sh memory_test.sh paging_test.sh process_fd_test.sh process_lifecycle_test.sh process_syscall_test.sh ramdisk_test.sh red_team_test.sh scheduler_safety_test.sh scheduler_test.sh shell_io_test.sh shell_test.sh syscall_file_test.sh syscall_negative_test.sh syscall_test.sh timer_preemption_test.sh timer_test.sh usermode_test.sh vfs_test.sh"
...
require_grep 'cow-demand-paging-guard-pages' "harness_profile.yaml"
